...
PROTECTION = -DCAN -DHASH

all: stack.exe


stack.exe: main.o stack.o
	$(CC) -o stack.exe main.o stack.o $(CFLAGS) $(PROTECTION)

main.o: main.cpp 
	$(CC) -o main.o main.cpp -c $(CFLAGS) $(PROTECTION)

stack.o: stack.cpp 
	$(CC) -o stack.o stack.cpp -c $(CFLAGS) $(PROTECTION)
